...
namespace HotelManagement.Data.Repositories
{
    public class PaymentRepository : IPaymentRepository
    {
        ...
        public async Task<ResponseDto> GetPayments(PaymentReqDto req)
        {
            ...
            response = (await _dbContext.ResponseDto
                .FromSqlRaw<ResponseDto>("EXEC APIPaymentGet {0}", pJson)
                .ToListAsync())
                .FirstOrDefault();
        ...
        public async Task<ResponseDto> InsertUpdatePayment(PaymentReqDto req)
        {
            ResponseDto response = new ResponseDto();
            var jsonString = JsonSerializer.Serialize(req);
            ...
            response = (await _dbContext.ResponseDto
                .FromSqlRaw<ResponseDto>("EXEC APIPaymentInsertUpdate {0}", pJson)
                .ToListAsync())
                .FirstOrDefault();
