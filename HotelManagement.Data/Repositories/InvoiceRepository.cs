...
namespace HotelManagement.Data.Repositories
{
    public class InvoiceRepository : IInvoiceRepository
    {
        ...
        public async Task<ResponseDto> GetInvoices(InvoiceReqDto req)
        {
            ...
            response = (await _dbContext.ResponseDto
                .FromSqlRaw<ResponseDto>("EXEC APIInvoiceGet {0}", pJson)
                .ToListAsync())
                .FirstOrDefault();
        ...
        public async Task<ResponseDto> InsertUpdateInvoice(InvoiceReqDto req)
        {
            ...
            response = (await _dbContext.ResponseDto
                .FromSqlRaw<ResponseDto>("EXEC APIInvoiceInsertUpdate {0}", pJson)
                .ToListAsync())
                .FirstOrDefault();
